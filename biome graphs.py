...
for i in range(23):
    ...
    forestmask =np.logical_and((groupimg[:,:,0]<=groupimg[:,:,1]+20),desertmask1)
...
plt.axis("off")
plt.colorbar
plt.title("Categorized biomes")
plt.imshow(curbiome)
plt.savefig("RepIm/biomemap.png")
...
plt.savefig("RepIm/BiomeVarTime")
